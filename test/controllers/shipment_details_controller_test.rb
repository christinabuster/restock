...
class ShipmentDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shipment_detail" do
    assert_difference("ShipmentDetail.count") do
      post shipment_details_url, params: { shipment_detail: { item_id: @shipment_detail.item_id, quantity: @shipment_detail.quantity, requested_quantity: @shipment_detail.requested_quantity, shipment_id: @shipment_detail.shipment_id } }
    end
  ...
  test "should update shipment_detail" do
    patch shipment_detail_url(@shipment_detail), params: { shipment_detail: { item_id: @shipment_detail.item_id, quantity: @shipment_detail.quantity, requested_quantity: @shipment_detail.requested_quantity, shipment_id: @shipment_detail.shipment_id } }
